        ...
        <div className="container ">
          ...
          {showAlert && (
            <div className="d-flex justify-content-center mb-4">
              <Alert variant="danger" onClose={() => setShowAlert(false)} dismissible className='admin-service-alert'>
          ...
          {showSuccessAlert && (
            <div className="d-flex justify-content-center mb-4">
              <Alert variant="success" onClose={() => setShowSuccessAlert(false)} dismissible className='admin-service-alert'>
          ...
          {/* Services List Cards */}
          <h3 className="mt-4 service-exist">
            <FontAwesomeIcon icon={faClipboardList} className="me-2" />
            Existing Services
          </h3>
          <hr />
